...
//
// IMPORTANT:
// In order to avoid FMODex you need to modify two openframeworks files and be sure that you add the definition -DUSE_OPENAL to the Project Settings (in my case "GCC 4.2" -> "Other C++ Flags"):
// ---------------------------------------------------------------------------------
//
//	ofMain.h (Line:xxx) :
//	//--------------------------
...
static const OSType	kActorID		= FOUR_CHAR_CODE('noWC');

// ### ACTOR NAME
// The name of the actor. This is the name that will be shown in the User Interface.

static const char* kActorName		= "NonoWebcam v.2";
